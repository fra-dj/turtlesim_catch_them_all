...
class TurtleSpawnerNode(Node): 
    def __init__(self):
        ...
        self.alive_turtles_ = []
        self.spawner_frequency_ = self.get_parameter("spawn_frequency").value

        self.alive_turtles_publisher_=self.create_publisher(
            TurtleArray, "alive_turtles", 10)
        self.spawn_turtle_timer_ = self.create_timer(
            1.0/self.spawner_frequency_, self.spawn_new_turtle)
    ...
    def spawn_new_turtle(self):
        ...
        self.call_spawner_server(name, x, y, theta)
    
    def call_spawner_server(self, turtle_name, x, y, theta):
